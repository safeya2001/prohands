          ...
          <div>
            ...
            <ul class="footer__contact">
              <li>
                ...
                Iraq Abdullah Street, Marka City, Amman, Jordan
              </li>
              <li>
              ...
              <li>
                ...
                <a href="mailto:ProHands.Training@protraining.org">ProHands.Training@protraining.org</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="footer__bottom">Copyright &copy; 2025 Pro Hands | All rights reserved.</div>
      </div>
    </footer>
    `;
  }
